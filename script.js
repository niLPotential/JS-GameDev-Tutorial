window.addEventListener("load", function () {
  ...
  class Player {
    ...
    update() {
      ...
      this.game.obstacles.forEach((obstacle) => {
        let [collision, distance, sumOfRadii, dx, dy] = this.game
          .checkCollision(this, obstacle);
        if (collision) {
  ...
  class Game {
    ...
    render(context, deltaTime) {
      ...
      if (
        this.eggTimer > this.eggInterval && this.eggs.length < this.maxEggs &&
        !this.gameOver
      ) {
        this.addEgg();
        this.eggTimer = 0;
      ...
      while (this.obstacles.length < this.numberOfObstacles && attempts < 500) {
        ...
        this.obstacles.forEach((obstacle) => {
          ...
          const sumOfRadii = testObstacle.collisionRadius +
            obstacle.collisionRadius + distanceBuffer;
        ...
        if (
          !overlap && testObstacle.collisionX > margin &&
          testObstacle.collisionX < this.width - margin &&
